  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import(/* webpackChunkName: "AsesoriaBasica" */ '../views/AsesoriaBasica.vue')
      },
      {
        path: '/AsesoriaCompleta',
        name: 'AsesoriaCompleta',
        // route level code-splitting
        // this generates a separate chunk (about.[hash].js) for this route
        // which is lazy-loaded when the route is visited.
        component: () => import(/* webpackChunkName: "AsesoriaCompleta" */ '../views/AsesoriaCompleta.vue')
      },
